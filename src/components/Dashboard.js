            ...
            <div className="utf-dashboard-content-inner-aera">
                ...
                <div className="utf-funfacts-container-aera">
                    ...
                    <div className="fun-fact" data-fun-fact-color="#0fc5bf">
                        <div className="fun-fact-icon">
                            <img src="../images/subscribe.png" alt="" className="img-dashboard" />
                        </div>
                        <div className="fun-fact-text">
                            <h4>120</h4>
                    ...
                    <div className="fun-fact" data-fun-fact-color="#f02727">
                        <div className="fun-fact-icon">
                            <img src="../images/research.png" alt="" className="img-dashboard" />
                        </div>
                        <div className="fun-fact-text">
                            <h4>2250</h4>
                ...
                <div className="row">
                    <div className="col-xl-6 col-md-12 col-sm-12">
                        ...
                        <div
                            className="utf-pagination-container-aera margin-top-10 margin-bottom-50"
                        >
